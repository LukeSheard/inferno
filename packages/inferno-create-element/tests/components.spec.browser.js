...
describe('Components (non-JSX)', () => {
	...
	it('should render a basic component with inputs', () => {
		...
		expect(container.firstChild.firstChild.firstChild.innerHTML).toEqual(
	...
	it('should render a basic component and remove property if null #1', () => {
		...
		expect(container.innerHTML).toEqual('<div><div class="basic"><span>The title is 123</span></div></div>');
	});
	...
	it('should render a basic component and remove property if null #2', () => {
		...
		expect(container.innerHTML).toEqual('<div><div class="basic"><span>The title is abc</span></div></div>');
	...
	it('should render a basic root component', () => {
		...
		expect(container.innerHTML).toEqual('<div class="basic"><span class="basic-render">The title is abc</span></div>');
		render(template(BasicComponent1, 'abc', 'basic-render'), container);
	...
	it('should render a basic component and correctly mount', () => {
		...
		expect(componentWillMountCount).toEqual(3);
	...
	describe('should render a basic component with conditional fragment', () => {
		...
		it('Initial render (creation)', () => {
			...
			expect(container.innerHTML).toEqual('<div><h1>BIG</h1><p>test</p></div>');
			render(createElement(ConditionalComponent, { condition: false }), container);
			expect(container.innerHTML).toEqual('<div><h2>small</h2><p>test</p></div>');
		});
	});
	...
	describe('should render a component with a conditional state item', () => {
		...
		it('Second render (update with state change)', done => {
			...
			requestAnimationFrame(() => {
				expect(container.innerHTML).toEqual(innerHTML('<div class="login-view bg-visma"><div>VISIBLE</div>'));
				done();
			});
		});
	});
	...
	describe('should render a component with a list of text nodes', () => {
		...
		it('Initial render (creation)', () => {
			...
			expect(container.innerHTML).toEqual(innerHTML('<div><div>Foo</div></div>'));
		});
		it('Second render (update)', () => {
			render(view(true), container);
			render(view(false), container);
			expect(container.innerHTML).toEqual(innerHTML('<div><div>BarQux</div></div>'));
		});
	});
