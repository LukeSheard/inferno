...
describe('Update (non-jsx)', () => {
	...
	it('should render a node with dynamic values', () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world - Inferno Owns</div>'));
		render(template('Inferno', 'Owns'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world - Inferno Owns</div>'));

		render(template('Inferno', null), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world - Inferno </div>'));

		render(template(null, 'Owns'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world -  Owns</div>'));
		...
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world - Test Works!</div>'));
	});
	...
	it('should update a wrapped text node', () => {
		...
		render(template(null), container);
		expect(container.innerHTML).toEqual(innerHTML('<div> foo</div>'));

		render(template('Hello', 'Bar'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello fooBar</div>'));

		render(template(undefined), container);
		expect(container.innerHTML).toEqual(innerHTML('<div> foo</div>'));

		render(template('The', ' is dead!'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>The foo is dead!</div>'));
	});
	...
	it('should update a wrapped text node', () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello foo</div>'));

		render(template(null, 'Bar'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div> fooBar</div>'));
	...
	it('should update a wrapped text node with 4 arguments', () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world! and Bar</div>'));
		...
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world! and Zoo</div>'));

		expect(() => render(template('Hello', [], ' and ', 'Zoo'), container)).toThrowError;

		render(template('Hello', null, ' and ', 'Zoo'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello and Zoo</div>'));

		expect(() => render(template('Hello', {}, ' and ', 'Zoo'), container)).toThrowError;

		render(template('Hello', ' poz', ' and ', 'Zoo'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello poz and Zoo</div>'));

		render(template('The ', 'bar', ' is', ' is dead!'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>The bar is is dead!</div>'));
	...
	it('should update a node with static text', () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<div id="Hello">Hello, World</div>'));

		render(template('Bar'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div id="Bar">Hello, World</div>'));
		...
		expect(container.innerHTML).toEqual(innerHTML('<div id="foo">Hello, World</div>'));
	});
	...
	it('should handle lots of dynamic variables', () => {
		...
		expect(() => render(template([], [], [], [], '', []), container)).toThrowError;
	});
	...
	it('should patch a wrapped text node with its container', () => {
		...
		render(template(span()), container);
		expect(container.innerHTML).toEqual(innerHTML('<div><div>Hello</div></div>'));
	});
	...
	it('should patch a text node into a tag node', () => {
		...
		render(template(span()), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>Hello</div>'));
	});
	...
	it('should patch a tag node into a text node #2', () => {
		...
		render(template(span()), container);
		expect(container.innerHTML).toEqual(innerHTML('<div><span>Good bye!</span></div>'));
	...
	it('should inject dynamic text various places', () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<div>There is no spoon!</div>'));

		render(div('one'), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>There is one spoon!</div>'));

		render(div(), container);
		expect(container.innerHTML).toEqual(innerHTML('<div>There is  spoon!</div>'));
	...
	it('should render a div tag and remove styling', () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<div style="color: red; padding-left: 10px;"></div>'));
