...
describe('Elements (JSX)', () => {
	...
	it("shouldn't render null value", () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<input>'));
	...
	it('should set values as properties by default', () => {
		...
		expect(container.innerHTML).toEqual(innerHTML('<input title="Tip!">'));

		render(<input name="Tip!" />, container);

		expect(container.firstChild.getAttribute('name')).toEqual('Tip!');
		expect(container.innerHTML).toEqual(innerHTML('<input name="Tip!">'));
	...
	it('handles JSX spread props (including children)', () => {
		...
		expect(innerHTML(container.innerHTML)).toEqual(innerHTML('<div class="lol" id="test">Hello world!</div>'));
	});
