...
suite('createElement', () => {
		...
		createElement('table', null, [
			...
			createElement('tbody', null, [
				createElement('tr', null, [
					...
					createElement('td', null, '4')
				]),
				createElement('tr', null, [
					createElement('td', null, '5'),
					createElement('td', null, '6'),
					createElement('td', null, '7'),
					createElement('td', null, '8')
				]),
				createElement('tr', null, [
					createElement('td', null, '9'),
					createElement('td', null, '10'),
					createElement('td', null, '11'),
					createElement('td', null, '12')
				])
			])
		]);
	});
	...
	benchmark('text node childs (table shape)', () => {
		createElement('table', null, [
			...
			createElement('tbody', null, [
				createElement('tr', null, [
					createElement('td', null, createElement('p', null, '1')),
					createElement('td', null, createElement('p', null, '2')),
					createElement('td', null, createElement('p', null, '3')),
					createElement('td', null, createElement('p', null, '4'))
				]),
				createElement('tr', null, [
					createElement('td', null, createElement('p', null, '5')),
					createElement('td', null, createElement('p', null, '6')),
					createElement('td', null, createElement('p', null, '7')),
					createElement('td', null, createElement('p', null, '8'))
				]),
				createElement('tr', null, [
					createElement('td', null, createElement('p', null, '9')),
					createElement('td', null, createElement('p', null, '10')),
					createElement('td', null, createElement('p', null, '11')),
					createElement('td', null, createElement('p', null, '12'))
				])
			])
		]);
	});
		...
		createElement('html', null, [
			...
			createElement(
				...
				createElement(
					...
					[
						createElement('header', null, createElement('h1', null, 'City Gallery')),
						createElement(
							'nav',
							{
								class: 'nav'
						...
						createElement(
							...
							[
								createElement('h1', null, 'London'),
								createElement('p', null, 'London'),
								createElement('p', null, createElement('strong', null, 'Resize'))
							]
						),
						createElement('footer', null, 'Copyright \xA9 W3Schools.com')
					]
				)
			)
		]);
